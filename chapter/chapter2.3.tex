...
Neben den Vorteilen birgt die Nutzung von \ac{NN} auch einige Nachteile. Zum einen ist die Genauigkeit der Prognose eines Modells stark abhängig von der Qualität der Trainingsdaten.
Werden Attribute im Trainingsdatensatz genutzt, die irrelevante bei der Beschreibung des Problems sind, wirkt sich das negativ aus auf die Genauigkeit des Modells, weshalb eine
