...
Wenn so ein Link gefunden wurde, dann wird der vollständige Pfad an eine spezielle Funktion übergeben, die als Rückgabewert den Namen des Produkts hat.
...
Unternehmensdaten sind, wurden diese hier entfernt.
